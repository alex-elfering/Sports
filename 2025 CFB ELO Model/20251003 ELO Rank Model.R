...
get_top_25 <- function(weekly_rankings, season_num, week_num) {
  weekly_rankings |>
    ...
    arrange(rank) |>
    select(season, rank, team, elo, rank_change, elo_change, last_result, next_week_info)
}
...
# Example usage
 ...
 get_team_season_trajectory(weekly_rankings, "James Madison", 2024)
 
 get_team_season_trajectory(weekly_rankings, team_name = 'Kansas State',2014)
 
 get_biggest_movers(weekly_rankings,2022,3)
 
 get_top_25(weekly_rankings,2000,10) |> as.data.frame()